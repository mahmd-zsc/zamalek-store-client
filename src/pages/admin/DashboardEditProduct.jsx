...
import UpdateProductImage from "../../components/updateProductImage/updateProductImage";
          ...
          <div className="sizes flex w-full flex-wrap gap-4">
            {sizes.map((size) => (
              <div
                ...
                className={`px-2 py-1 text-black rounded-lg border-2 cursor-pointer duration-200 hover:scale-110 ${
