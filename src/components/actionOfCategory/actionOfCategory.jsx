...
function ActionOfCategory({ categoryId }) {
  ...
  let editHandler = () => {
    ...
    // dispatch(dashboardActions.setEditSizeId(categoryId));
    dispatch(dashboardActions.setAction("edit-category"));
...
export default ActionOfCategory;
